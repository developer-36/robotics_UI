    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
          <h1 className="h1 mb-6">Explore the Possibilities of AI Chatting with{" "}
            <span className="inline-block relative">
              Brainwave{" "}
              <img src={curve} className="absolute top-full left-0 w-full xl:mt-2" alt="curve" width={624} height={28} />
            </span>
          </h1>
          <p className="mt-6 body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                <img src={robot} alt="AI" className={`w-full scale-[1] -translate-y-[17%] lg:-translate-y-[23%]`} width={1024} height={490} />
          ...
          <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[66%] md:w-[138%] lg:-top-[104%]">
